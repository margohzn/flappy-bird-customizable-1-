...
#changing the size of the restrat image which apperas when the game is over and the bird is not flying
restart = pygame.transform.scale(button_img, (400,175))
...
while is_running:
    ...
    if flying == True and game_over == True:
        screen.blit(restart, (200,200))
